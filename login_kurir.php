...
<center>
    <div class="bg" style="margin-top: 50px">  
        ...
        <h5>Login Customer</h5>
			...
			<form method="POST" action="login_kurir_proses.php" style="margin-top: 40px">
				<div class="text-center" style="width: 250px">
					...
					<button class="btn btn-secondary btn-lg btn-outline-light; mb-3" type="submit">Login</button>
				</div>
			</form>
            <small>Belum punya akun? <a href="register.php" class="text-reset">Daftar di sini.</a></small>
		</div>
	</center>
</body>
</html>